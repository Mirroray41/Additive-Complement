...
public class BlockRegistry {
    ...
    public static final Block MOSSY_COBBLED_DEEPSLATE = registerBlock("mossy_cobbled_deepslate",
            new Block(FabricBlockSettings.of(Material.METAL).strength(4f).requiresTool()), ItemGroup.MISC);
    public static final Block MOSSY_BLACKSTONE = registerBlock("mossy_blackstone",
            new Block(FabricBlockSettings.of(Material.METAL).strength(4f).requiresTool()), ItemGroup.MISC);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICK_STAIRS = registerBlock("cracked_polished_blackstone_brick_stairs",
            new StairBlockBuilder(FabricBlockSettings.of(Material.METAL).strength(4f).requiresTool()), ItemGroup.MISC);
